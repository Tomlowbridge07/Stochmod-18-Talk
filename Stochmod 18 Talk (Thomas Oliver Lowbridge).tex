...
We wish to model a moving patroller with attackers who arrive on a network, with some type of suspicious attackers.

As an example, we could consider a security guard patrolling a museum, with attackers who are trying to steal parts of the exhibits in each room. We implement semi-intelligent thieves, if they arrive and see the guard they will wait until they try  to steal.
\end{frame}
